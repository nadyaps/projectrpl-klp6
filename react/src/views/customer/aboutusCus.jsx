...
export default function  AboutUs() {
  return (
    <div className="w-full mt-24 bg-white flex flex-col justify-center items-center gap-12 p-8 md:p-12 lg:p-16">
      <h1 className="text-center text-4xl font-[BebasNeue]">ABOUT US</h1>
