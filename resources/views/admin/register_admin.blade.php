                  ...
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="userPassword" autocomplete="konfirmasi-current-password" placeholder="Konfirmasi Password">
                      </div>
                      <div>
                        <a href="/admin/login" class="btn btn-primary text-white me-2 mb-2 mb-md-0">Register</a>
                      </div>
                      <a href="/admin/login" class="d-block mt-3 text-muted">Sudah Ada Akun? Login</a>
                    </form>
                  </div>
                </div>
              </div>
