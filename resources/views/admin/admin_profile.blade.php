      ...
      <div class="card-body">
        <div class="d-flex flex-row align-items-center justify-content-between mb-3">
          ...
          <div class="d-flex justify-content-center mt-5 mb-5 ">
            <img class="wd-md-400 wd-300" src="{{ (!empty ($profileAdmin->photo)) ? url('/admin_image/' .$profileAdmin->photo) :url('no_image.jpg')}}" alt="profile">
          </div>
        <div class="d-flex justify-content-center gap-6 mb-5">
          <div class="">
             <div class="mt-3">
              <label class="tx-13 fw-bolder mb-0 text-uppercase">Username:</label>
              <p class="text-muted">{{ $profileAdmin->username }}</p>
            </div>
            <div class=" mt-3">
                ...
                <div class="modal-body">
                  <form class="forms-sample"> 
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="username" class="form-control" id="exampleInputUsername2" value="{{ $profileAdmin->username }}">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Email</label>
                      <div class="col-sm-9">
                        <input type="email" name="email" class="form-control" id="exampleInputEmail2" autocomplete="off" value="{{ $profileAdmin->email }}">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Nama</label>
                      <div class="col-sm-9">
                        <input type="text" name="name" class="form-control" id="exampleInputMobile" value="{{ $profileAdmin->name }}">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Nomor Telepon</label>
                      <div class="col-sm-9">
                        <input type="number" name="phone" class="form-control" id="exampleInputMobile" value="{{ $profileAdmin->phone }}">
                      </div>
                    </div>                    
                    <div class="row mb-3">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Alamat</label>
                      <div class="col-sm-9">
                        <input type="text" name="address"  class="form-control" id="exampleInputMobile" value="{{ $profileAdmin->address }}">
                      </div>
                    ...
                    <div class="row mt-3 mb-3">
                      ...
                      <img  id="showImage" class="wd-100 rounded-circle" src="{{ (!empty ($profileAdmin->photo)) ? url('/admin_image/' .$profileAdmin->photo) :url('no_image.jpg')}}" alt="profile">
                    </div>
                  </form>
                 </div>
